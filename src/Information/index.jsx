...
const informationData = {
  notice: {
    name: '예식 안내',
    img: 'https://wedding.dddproject.com/skin/tpl/wedding05/images/info04.jpg',
    content:
      '예식이 진행되는 중간 자리로 식사가 서빙되는 동시예식으로 진행됩니다. 예식 진행 및 식사 후 2부가 준비되어 있으니 즐거운 마음으로 함께 해 주시면 감사하겠습니다! 한 분 한 분 소중한 마음으로 인사드리겠습니다:)',
  },
  parking: {
    name: '주차 안내',
    img: 'https://wedding.dddproject.com/skin/tpl/wedding05/images/info01.png',
    content:
      '예식장 내 주차장에 자가 주차가 가능합니다. 주차 공간이 부족할 경우 인근 다른 주차장으로 안내될 수 있는 점 양해 부탁드립니다.',
  },
  dining: {
    name: '식사 안내',
    img: 'https://wedding.dddproject.com/data/file/order_form/2113089417_roYRq620_0fa0c8da4b5079cfecdfc92f357fd118808a1df3.png',
    content:
