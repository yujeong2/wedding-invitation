...
const informationData = {
  notice: {
    ...
    img: noticeImg,
    content:
      '예식이 진행되는 중간 자리로 식사가 서빙되는 동시예식으로 진행됩니다. 1부 예식 이후 식사 및 2부가 준비되어 있으니 즐거운 마음으로 함께 해 주시면 감사하겠습니다!',
  },
  parking: {
    name: '주차 안내',
    img: parkingImg,
  ...
  dining: {
    ...
    img: diningImg,
    content:
      '스테이크가 서빙되는 양식 코스로 진행됩니다. 혹시 먼저 식사를 원하시는 경우에는 7층 서브홀로 이동하시면 예식을 영상으로 함께 하시며 미리 식사하실 수 있습니다.',
  },
};
